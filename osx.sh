...
# ~/.osx — based off of https://mths.be/osx
...
sudo scutil --set ComputerName "bristlecone"
sudo scutil --set HostName "bristlecone"
sudo scutil --set LocalHostName "bristlecone"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "bristlecone"
