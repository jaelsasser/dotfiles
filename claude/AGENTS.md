...
This package holds the Claude Code configuration: `USER_CLAUDE.md` (symlinked to `~/.claude/CLAUDE.md`), skills under `skills/`, hooks + `settings.json` wiring under `hooks/`, the `cac` plugin under `plugins/`, and glob-scoped rules under `rules/`.
