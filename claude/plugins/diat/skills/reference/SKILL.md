---
name: reference
description: Reference-mode docs — accurate, scannable description of how a thing works: options, flags, variables, interfaces, behaviour. Use for the descriptive parts of a README, API/config reference, man page, or what-it-is sections.
---
...
Reference register: engineer-to-engineer BSD manpage tradition — describe the system, not the reader's experience; no marketing.
